...
SOPCINFO_FILE := D:/dooby/git_repos/maxduino/top_system.sopcinfo
...
# Design Name 
# setting SOPC_NAME is top_system
SOPC_NAME := top_system
...
# setting hal.stderr is console_for_processor
ELF_PATCH_FLAG  += --stderr_dev console_for_processor

# Slave descriptor of STDIN character-mode device. This setting is used by the 
# ALT_STDIN family of defines in system.h. none 
# setting hal.stdin is console_for_processor
ELF_PATCH_FLAG  += --stdin_dev console_for_processor
...
# setting hal.stdout is console_for_processor
ELF_PATCH_FLAG  += --stdout_dev console_for_processor
