...
# Memory: processor_code
MEM_0 := top_system_processor_code
$(MEM_0)_NAME := processor_code
...
$(MEM_0)_HIERARCHICAL_PATH := processor_code
$(MEM_0)_WIDTH := 32
$(MEM_0)_HEX_DATA_WIDTH := 32
$(MEM_0)_ENDIANNESS := --little-endian-mem
$(MEM_0)_CREATE_LANES := 0

.PHONY: processor_code
processor_code: check_elf_exists $(MEM_INIT_DIR)/$(MEM_0).hex $(HDL_SIM_DIR)/$(MEM_0).dat $(HDL_SIM_DIR)/$(MEM_0).sym
